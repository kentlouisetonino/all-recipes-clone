...
import { createRecipeAPI } from 'src/api/recipe'
...
const AddRecipe = () => {
  ...
  return (
    <>
      <Header title='All Recipes | Add Recipe' />
      ...
      <div className='d-flex'>
        ...
        {isLoading ? (
          ...
          <div className='flex-shrink-1' style={{ width: '800px' }}>
            <div className='mx-5'>
              <h3 className='fw-bolder'>Add Recipe Information</h3>
              <div className='w-75 mt-5'>
                ...
                <div className='mb-4'>
                  <TextAreaField
                    label='Ingredients'
                    placeholder='Enter the ingredients. Arrange it to bullet or numbered list'
                    value={ingredients}
